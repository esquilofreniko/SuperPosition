...
void ProbSeq::drawKey(int k, int i, int j){
  if(view == 0){
    if(param==0){
    ...
    if(param==2){
      if(clockDiv[k][(i%4)+(j*4)+(division*16)] < clockDivision){
        kp.set((i%4)+(j*4),4);
      }
      if(clockDiv[k][(i%4)+(j*4)+(division*16)] > clockDivision){
        kp.set((i%4)+(j*4),2);
      ...
      if(clockDiv[k][(i%4)+(j*4)+(division*16)] == 0){
        kp.set((i%4)+(j*4),0);
      }
    }
  }
  if(view == 1){
    ...
    if(param == 2){
      if(clockDiv[j][i+(k*4)+(division*16)] < clockDivision){
        kp.set((i%4)+(j*4),4);
      }
      if(clockDiv[j][i+(k*4)+(division*16)] > clockDivision){
        kp.set((i%4)+(j*4),2);
      ...
      if(clockDiv[j][i+(k*4)+(division*16)] == 0){
        kp.set((i%4)+(j*4),0);
      }
    }
  }
